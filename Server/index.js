...
const io = new Server(server, { cors: { origin: ['https://test-chat-app-no37.onrender.com', 'https://test-chat-app-1.onrender.com'], credentials: true } });


app.use(express.json());
app.use(cookieParser());

app.use(cors({ origin: ['https://test-chat-app-1.onrender.com', 'https://test-chat-app-no37.onrender.com'], credentials: true }));
